    ...
    <>
      ...
      <section className="container py-24">
        <div className="flex items-end justify-between gap-6">
          <div>
            <p className="eyebrow text-black/50">Trending now</p>
        ...
        {trending.length ? (
          ...
          <div className="mt-12 rounded-3xl border border-dashed border-black/15 px-6 py-20 text-center">
            <p className="text-black/50">No products yet. Add your first product from the admin dashboard.</p>
          </div>
        )}
      </section>
      <section className="bg-[#061426] text-white">
        <div className="container grid gap-14 py-24 md:grid-cols-2 md:items-end">
          ...
          <div>
            <p className="max-w-md text-sm leading-7 text-white/60">Static photos don&apos;t always tell the full story. Where available, category listings can include short product video previews using the product image as the visual starting point.</p>
      ...
      <section className="container py-24">
        <div className="rounded-[2px] border border-black/10 p-8 md:p-14">
          <p className="eyebrow text-black/45">Need a closer look?</p>
