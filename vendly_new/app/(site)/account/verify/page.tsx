      ...
      <div>
        {user ? (
          <>
            ...
            <p className="mt-2 text-sm text-[rgba(0,0,0,0.5)]">Thanks, {user.name || 'you'} — your Vendly account is confirmed.</p>
          </>
        ) : (
          <>
            <XCircle className="mx-auto text-[rgba(0,0,0,0.4)]" size={40} />
            <h1 className="mt-5 text-3xl font-bold">That link has expired.</h1>
            <p className="mt-2 text-sm text-[rgba(0,0,0,0.5)]">Verification links are valid for 48 hours. You can request a new one from your account page.</p>
          </>
        )}
