export type Product = { id:string; slug:string; name:string; category:string; price:number; oldPrice?:number; image:string; images?:string[]; video?:string; badge?:string; description:string; sizes?:string[]; stock?:number; isPreorder?:boolean; preorderNote?:string; createdAt?:string; featured?:boolean };
